...
export class BandejaoComponent {
  textAndImageList: AlternatingLayoutModel[] = [
    ...
    {
      text: 'Você também pode gerar uma chave PIX (copia e cola) para fazer a recarga pelo <strong><a target="_blank" rel="noopener noreferrer" href="https://portalservicos.usp.br">Portal de Serviços</a></strong>: Restaurante Universitário → Pix → Comprar, para emitir a chave e poder pagar via Pix. Ou pelo aplicativo <strong>Cardápio USP:</strong> ícone de dinheiro logo abaixo de "SALDO RUCard" → fazer login → inserir um valor entre R$10,00 e R$200,00 → pagamento PIX, para pagar via Pix. <br><br>Vale notar que uma vez pago, o valor cai na sua conta em no máximo alguns minutos.',
    },
    {
      image: {
    ...
    },
    {
      ...
      text: 'Você pode consultar o cardápio do dia pelo <a target="_blank" rel="noopener noreferrer" href="http://www.puspsc.usp.br/cardapio/">site da prefeitura do campus</a>, pelo aplicativo <a target="_blank" rel="noopener noreferrer" href="https://sites.usp.br/sas/exemplo-de-post-2/">Cardápio USP</a>, ou até mesmo por um <a href="https://t.me/BandejaoBot" target="_blank" rel="noreferrer noopener">bot no telegram</a>.<br><br>Durante o período da pandemia, o bandejão foi oferecido por meio de marmitas, ou seja, não era permitido comer no restaurante. No dia 07/02/2022, houve a reabertura do bandejão presencial com distanciamento entre as cadeiras, tendo bem menos ocupação do que o normal. Porém tais medidas já ficaram no passado e, nos últimos anos, segue sendo possível adentrar ao restaurante para se alimentar.<br><br>Estudantes com dificuldades socioeconômicas podem acessar o auxílio alimentação oferecido pela <a target="_blank" rel="noopener noreferrer" href="http://www.puspsc.usp.br/bolsas-e-auxilios/">prefeitura do campus</a>.',
    },
  ]
}
