  ...
  textAndImageList: AlternatingLayoutModel[] = [
    {
      ...
      text: 'Aqui na USP São Carlos, o curso de Engenharia Elétrica é dividido em duas ênfases: <strong>Sistemas de Energia e Automação</strong> e <strong>Eletrônica</strong>. Sendo que cada uma dessas ênfases recebe 50 novos alunos por ano, fazendo com que a Elétrica seja o curso com mais bixos na EESC. <br><br>Vale ressaltar que, apesar dessa separação por ênfase, todos são do mesmo curso, sendo coordenados pelo SEL (Departamento de Engenharia Elétrica e de Computação) e representados pela SA-SEL. Em outras palavras, <strong>estamos todos no mesmo barco</strong>.',
    },
    {
    ...
    },
    {
      ...
      text: 'Aqui seguem alguns links complementares que irão elucidar um pouco sobre a proposta do curso. O principal deles é o Projeto Pedagógico, ele é um documento com todas as informações sobre grade curricular, conhecimentos abrangidos, perfil de graduado, entre vários outros assuntos, ele inclusive fala sobre os Certificados Especiais que você pode adquirir ao longo da graduação conforme a escolha de suas disciplinas optativas. Também estará linkado as informações sobre o curso encontradas no site da SEL, que de forma resumida descrevem sua proposta.<br><br><ul><li>Eletrônica: <a target="_blank" rel="noopener noreferrer" href="https://sel.eesc.usp.br/home/graduacao/enfase-em-eletronica/">Informações</a> <a target="_blank" rel="noopener noreferrer" href="https://sel.eesc.usp.br/sel/wp-content/uploads/2024/12/pp_ee1.pdf">Projeto Pedagógico</a></li><li>Sistemas de Energia e Automação: <a target="_blank" rel="noopener noreferrer" href="https://sel.eesc.usp.br/home/graduacao/enfase-em-sistemas-de-energia-e-automacao/">Informações</a> <a target="_blank" rel="noopener noreferrer" href="https://sel.eesc.usp.br/sel/wp-content/uploads/2023/09/Projeto_Pedagogico_SEA_junho20161.pdf">Projeto Pedagógico</a></li><li><a target="_blank" rel="noopener noreferrer" href="https://eesc.usp.br/graduacao/complementares.php?anchor=certificados_especiais">Certificados e Estudos Especiais</a></ul>',
    },
  ]
}
